...
var eventList = [
  Event(
    ...
    photoCover: 'assets/images/cover-water-puppet.jpg',
    ...
    location: Location(
      ...
      latitude: 21.03178781289234, 
      longitude: 105.85336409805987,
    ),
    date: '2022-06-01',),
  Event(
    title: 'Authentic \nBat Trang',
    ...
    photoCover: 'assets/images/cover-pottery.jpg',
  ...
  Event(
    ...
    photoCover: 'assets/images/cover-summer-market.jpg',
    ...
    location: Location(
      country: 'Vietnam',
      address: 'Complex 01, N.29, 31/67, Tay Son, Dong Da, Ha Noi, Vietnam',
