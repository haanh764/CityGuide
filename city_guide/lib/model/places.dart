...
var placeList = [
  Place(
    ...
    rating: 4.8, 
    reviews: [
      'A very good museum which provides good insight into the French colonial struggles from the perspective of Vietnam.  Enjoyable isnt the right way to describe a visit, but is is very insightful and we will worthwhile.  Also excellent value.',
      ...
      'Hoa Lo Prison aka Hanoi Hilton. John McCain was held here with many other American POWs. Place is both extremely interesting and extremely gut wrenching at the same time. It`s a must visit though. If you don`t come visit then why are you even in Hanoi to begin with?',
      'A must see. The exhibits give a clear, if somewhat disturbing, view of the abuses by colonialism during the early 20th century. Usage during the US/Vietnam War is not mentioned.',
      'Good organizing museum. Easy to understand with audio option. It`s sad and very emotional to see the cruelty of war but it`s worth to visit if you have about 2 hours time.',
    ],
  ),
  Place(
    name: 'Hoan Kiem Lake', 
    ...
    reviews: [
      ...
      'Very peaceful and beautiful place for day and night strolls. So much good memories there ❤️',
      'This is a popular lake inside the Old Quarter of Hanoi City. Basically, this lake is a part of the drainage system in Hanoi City as its main function. Located in the city center near a shopping center, restaurant, bars, offices, and another business center, make this lake is becoming one of the tourist areas. For local people,  they build a temple on the small island in the lake with a wooden bridge to go there. So they come to this place to give respect to God. For your note, there would be a crowd along with the festival or a ritual of the religion. At night tourists and local people take a walk surrounding this lake to see the beauty of the lake by the reflection of the light on the surface of the water.',
      'Walking plaza around this area is quite good during weekend. Very lively atmosphere. You will also mired in to happy thoughts.',
      'It`s a nice place to stroll by in the evenings. Expect a lot of tourists, local crowd and vendors.. If you`re lucky, you`ll find a seat. If you truly want to view it in its glory, visit by night to experience the beauty of the lake when the red bridge is lit up',
    ],
  ),
  Place(
    ...
    reviews: [
      ...
      'Beautiful building built by French in 1900, spectacular monument! Also inside is really nice with great acustic. Many different kind of performances often here, is a must to go place! Also just outside during day or night is full of life me aggregation spot for many Vietnamese! Amazing place!',
      'Beautiful, classical opera house in the heart of Hanoi. I came here to see the "My Village" acrobatic performance. Both the venue and the show are fantastic. It surpassed my expectations. I`ve seen multiple acrobatic shows around the world - Cirque du Soleil, House of Dancing Water, Chinese acrobatic shows - and this one deserves its place right up there! It has local flair to it that really captured the Vietnamese culture in a beautiful way.',
      'Since opera houses are intended for opera, theatre and concerts, the best way to evaluate is by attending such an event. I went to hear a classical concert featuring a stunning flautist. The acoustics and visibility were terrific, as was my physical comfort. The building was stunning, viewed from the outside, at night, and equally so from the inside. Highly recommended!',
    ],
  ),
  Place(
    ...
    rating: 4.5, 
    reviews: [
      'A beautiful and historic architecture, that needs to be seen during the day and night. It`s simply beautiful. Remember you need to see it twice, one in the day and the other at night. There are a lot of eateries, coffee joints and pubs nearby. You can see them in the panoramic pic.',
      'A must-see place for all tourists ti visit in Hanoi. Next to lots of restaurants, cafe and famous snacks in town.',
      'Today is a Sunday, I am here to pray for all people in the World. The Cathedral is very classic and old but the This Catholic Church is so Holly. I love here and come here when I will be in Ha Noi. Come to visit',
      'The church itself is amazing. Most people visit here are not believers, just for their social media posts. If you want to celebrate Xmas and NYE with calmer atmosphere, visit Ham Long Church.',
      'A beautiful and historic architecture. The church was lovely during Christmas period. There were decorations outside and the streets around were lit up. There are a lot of eateries, coffee joints and pubs nearby.',
    ],
  ),
  Place(
    ...
    rating: 4.3, 
    reviews: [
      'The check-in place should not be missed when coming to Hanoi. If you are lucky, you can see the train running right in front of your eyes. It feels great 🔥🔥',
      'Great place to relax and enjoy a drink. Train comes every 1-1.5 hrs. The locals have a schedule on hand. The train passes by awfully close and is fun. Remember to stay safe and don`t do anything stupid. The train conductors are playful and will give you an couple extra honks if you ask for it.',
      'We got lucky. Google said 7pm was the first train, while we got to see it at 545ish. A very nice place to visit, I`m happy we went during Tet when the city is dead and busy spots like this are open. Interestingly, I was reviewing a video I was making, of the train and one of the residences  heard it and started warning the entire street. Keen ears and communication.',
      'This place is amazing! Check it out and definitely buy drinks and food from the folks who live there and make a living serving the people enjoying the show.',
      'It was absolutely amazing and memorable place for us during our digital nomad trip. You can eat or drink delicious food, coffee and beer. I recommend it for everyone who want to travel to Hanoi. :)',
    ],
  ),
];