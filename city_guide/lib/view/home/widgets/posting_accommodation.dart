...
import 'package:city_guide/view/detail/accommodation/detail_accommodation_screen.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';

class PostingAccommodation extends StatelessWidget {
  const PostingAccommodation({Key? key}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        const Padding(
          padding: EdgeInsets.only(left: 16.0, top: 2.0),
          child: Text(
            'Explore the nearby accommodations',
            style: TextStyle(
              fontSize: 12,
              fontFamily: 'NunitoSans',
              color: grey,
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(context,
                        ...
                        return DetailAccommodationScreen(
    ...
    return Row(
      ...
      children: [
        SizedBox(
          ...
          height: 56,
          child: Hero(
            tag: accommodation.photoCover,
            child: ClipRRect(
              borderRadius: BorderRadius.circular(8.0),
              child: Image.asset(
                accommodation.photoCover,
                fit: BoxFit.cover,
              ),
            ),
          ),
