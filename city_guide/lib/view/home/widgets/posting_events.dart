...
import 'package:city_guide/view/detail/event/detail_event_screen.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';

class PostingEvent extends StatelessWidget {
  const PostingEvent({Key? key}) : super(key: key);
